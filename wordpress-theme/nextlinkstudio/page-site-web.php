      ...
      <div class="portfolio-grid--triple" style="grid-template-columns: repeat(2, 1fr); max-width: 780px; margin: 0 auto;">
        <div class="pf-card" data-category="site-web">
          ...
          <div class="pf-card-body">
            ...
            <div class="pf-card-actions">
              <a href="https://www.lesjardinsduchene.fr/?utm_source=nextlinkstudio&utm_medium=portfolio&utm_campaign=bouton_voir_le_site&utm_content=page_site_web" target="_blank" rel="noopener" class="pf-card-site-link">Voir le site web →</a>
        ...
        <div class="pf-card" data-category="site-web">
          ...
          <div class="pf-card-body">
            ...
            <div class="pf-card-actions">
              <a href="https://www.profilboost.fr/?utm_source=nextlinkstudio&utm_medium=portfolio&utm_campaign=bouton_voir_le_site&utm_content=page_site_web" target="_blank" rel="noopener" class="pf-card-site-link">Voir le site web →</a>
