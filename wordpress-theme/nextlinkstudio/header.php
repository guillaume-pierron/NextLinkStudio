        ...
        <li class="nav-dropdown">
          ...
          <div class="dropdown-menu">
            <div class="dropdown-menu-inner">
              ...
              <a href="<?php echo nls_page_url( 'reseaux-sociaux' ); ?>" class="dropdown-item di-linkedin">
              ...
              <a href="<?php echo nls_page_url( 'print' ); ?>" class="dropdown-item di-print">
      ...
      <div class="nav-mobile-nav">
        <div class="nav-mobile-group">
          ...
          <div class="nav-mobile-submenu"><div class="nav-mobile-submenu-inner">
            ...
            <a href="<?php echo nls_page_url( 'reseaux-sociaux' ); ?>" onclick="toggleMenu()"><span class="nm-service-icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg></span>Réseaux sociaux</a>
            <a href="<?php echo nls_page_url( 'print' ); ?>" onclick="toggleMenu()"><span class="nm-service-icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 6 2 18 2 18 9"/><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/><rect x="6" y="14" width="12" height="8"/></svg></span>Création print</a>
          </div></div>
        </div>
