        ...
        <a href="<?php echo nls_page_url('etude-de-cas-elec-prime'); ?>" class="pf-card">
          ...
          <div class="pf-card-body">
            <div class="pf-card-top">
              ...
              <div><h4 class="pf-card-title">Élec Prime</h4><p class="pf-card-desc">Site web + identité visuelle · Île-de-France</p></div>
            </div>
            <div class="pf-stats">
        ...
        <a href="<?php echo nls_page_url('etude-de-cas-vert-nature'); ?>" class="pf-card">
          ...
          <div class="pf-card-body">
            <div class="pf-card-top">
              ...
              <div><h4 class="pf-card-title">Vert-Nature</h4><p class="pf-card-desc">Site web + identité visuelle · France</p></div>
            </div>
            <div class="pf-stats">
